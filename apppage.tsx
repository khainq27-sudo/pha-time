...
const styles: any = {
  ...
  topCardWrapper: { padding: "0 15px", marginTop: "20px", width: "100%", boxSizing: "border-box"  },
  topCard: { 
    display: "flex", 
    flexDirection: "row",
    flexWrap: "wrap",
  ...
  timeFrameBox: { display: "flex", gap: 10, paddingLeft: "15px", marginTop: "40px", alignItems: "center" },
  ...
  responsiveGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "45px 10px", paddingLeft: "35px", paddingRight: "10px" },
